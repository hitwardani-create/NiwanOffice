...
export const strings = {
  zh: {
    ...
    setAiGensparkHint: '使用 账号登录，无需 API key。',
    setAiByokNote: '对话使用你自己的 key；网页搜索、生图等云工具仍需登录。',
    setAiSave: '保存',
    setAiSaved: '已保存',
    setAiTest: '测试连接',
    setAiTesting: '测试中…',
    ...
    setAiGskTools: '云端 AI 工具',
    setAiGskToolsDesc:
      '网页搜索、AI 生图、媒体分析经 Genspark 云端并消耗积分；关闭后生图与媒体分析不可用，搜索改用免费来源。',
    setGithub: '开源项目',
    starOnGitHub: '去 GitHub 点 Star',
    starPromptTitle: '喜欢 NiwanOffice 吗？',
    starPromptTitleN: '你已经用 NiwanOffice 打开了 {n} 个文档',
    starPromptBody: 'NiwanOffice 是免费开源软件。到 GitHub 给我们一个 Star，是对团队最好的支持。',
    starPromptGo: '去点 Star',
    starPromptDone: '已经点过了',
    starPromptLater: '以后再说',
    onbStarHint: '如果你喜欢 NiwanOffice，欢迎到 GitHub 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
  ...
  en: {
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountGenspark: 'Account',
    account: 'Account',
    login: 'Sign in',
    loginGenspark: 'Sign in',
    loggedIn: 'Signed in',
    loggedInGenspark: 'Signed in',
    ...
    starPromptTitleN: "You've opened {n} documents with NiwanOffice",
    starPromptBody:
      'NiwanOffice is free and open source. A star on GitHub is the best way to support the team.',
    starPromptGo: 'Star on GitHub',
    starPromptDone: 'Already starred',
    starPromptLater: 'Maybe later',
    onbStarHint: 'If you like NiwanOffice, give us a star on GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to NiwanOffice',
  ...
  ja: {
    ...
    noContent: '（内容なし）',
    // Account
    accountGenspark: 'アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginGenspark: 'アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInGenspark: 'サインイン済み',
    waitingLogin:
    ...
    setAiGensparkHint: 'アカウントでサインインするため、API キーは不要です。',
    setAiByokNote:
    ...
    setAiGskTools: 'クラウド AI ツール',
    setAiGskToolsDesc:
      'ウェブ検索・AI 画像生成・メディア分析は Genspark クラウド経由でクレジットを消費します。オフにすると画像ツールは使えず、検索は無料ソースを使用します。',
    setGithub: 'オープンソース',
    starOnGitHub: 'GitHub でスターを付ける',
    starPromptTitle: 'NiwanOffice はいかがですか？',
    starPromptTitleN: 'NiwanOffice で {n} 件のドキュメントを開きました',
    starPromptBody:
      'NiwanOffice は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
    starPromptGo: 'スターを付ける',
    starPromptDone: 'スター済み',
    starPromptLater: 'あとで',
    onbStarHint: 'NiwanOffice が気に入ったら、GitHub でスターをお願いします。',
    setEmail: 'メール',
  ...
  ko: {
    ...
    cloudRefresh: '새로고침',
    cloudLoginHint: '계정에 로그인하면 웹에서 만든 프로젝트를 볼 수 있습니다.',
    ...
    account: '계정',
    login: '로그인',
    loginGenspark: '계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInGenspark: '로그인됨',
    ...
    setAiGensparkHint: '로그인으로 사용하며 API 키가 필요 없습니다.',
    setAiByokNote:
      '대화는 자신의 키를 사용합니다. 웹 검색·이미지 생성 등 클라우드 도구는 여전히 로그인이 필요합니다.',
    setAiSave: '저장',
    setAiSaved: '저장됨',
    setAiTest: '연결 테스트',
    setAiTesting: '테스트 중…',
    ...
    setAiGskTools: '클라우드 AI 도구',
    setAiGskToolsDesc:
      '웹 검색·AI 이미지 생성·미디어 분석은 Genspark 클라우드를 거치며 크레딧을 사용합니다. 끄면 이미지 도구를 사용할 수 없고 검색은 무료 소스를 사용합니다.',
    setGithub: '오픈 소스',
    starOnGitHub: 'GitHub에서 스타 누르기',
    starPromptTitle: 'NiwanOffice가 마음에 드시나요?',
    starPromptTitleN: 'NiwanOffice로 문서를 {n}개 열어보셨네요',
    starPromptBody:
      'NiwanOffice는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
    starPromptGo: '스타 누르기',
    starPromptDone: '이미 눌렀어요',
    starPromptLater: '나중에',
    onbStarHint: 'NiwanOffice가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
    setEmail: '이메일',
  ...
  fr: {
    ...
    noContent: '(vide)',
    // Account
    accountGenspark: 'Compte',
    account: 'Compte',
    login: 'Se connecter',
    loginGenspark: 'Se connecter avec Genspark',
    loggedIn: 'Connecté',
    loggedInGenspark: 'Connecté',
    waitingLogin:
    ...
    starPromptTitle: 'NiwanOffice vous plaît ?',
    starPromptTitleN: 'Vous avez ouvert {n} documents avec NiwanOffice',
    starPromptBody:
      'NiwanOffice est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
    starPromptGo: 'Mettre une étoile',
    starPromptDone: 'Déjà fait',
    starPromptLater: 'Plus tard',
    onbStarHint: 'Si NiwanOffice vous plaît, mettez-nous une étoile sur GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans NiwanOffice',
    ...
    onbBody2:
      'NiwanOffice est encore en alpha. Rejoignez la discussion de groupe sur GenTeam pour partager vos retours et façonner la suite.',
  ...
  de: {
    ...
    cloudLoginHint:
      'Melden Sie sich bei Ihrem Konto an, um Ihre im Web erstellten Projekte zu sehen.',
    ...
    starPromptTitle: 'Gefällt Ihnen NiwanOffice?',
    starPromptTitleN: 'Sie haben {n} Dokumente mit NiwanOffice geöffnet',
    starPromptBody:
      'NiwanOffice ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
    starPromptGo: 'Stern geben',
    starPromptDone: 'Schon erledigt',
    starPromptLater: 'Später',
    onbStarHint: 'Wenn Ihnen NiwanOffice gefällt, geben Sie uns einen Stern auf GitHub.',
    setEmail: 'E-Mail',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei NiwanOffice',
    ...
    onbBody2:
      'NiwanOffice ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf GenTeam bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
  ...
  es: {
    ...
    setAiGskTools: 'Herramientas en la nube',
    setAiGskToolsDesc:
    ...
    starPromptTitle: '¿Te gusta NiwanOffice?',
    starPromptTitleN: 'Has abierto {n} documentos con NiwanOffice',
    starPromptBody:
      'NiwanOffice es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
    starPromptGo: 'Dar una estrella',
    starPromptDone: 'Ya la di',
    starPromptLater: 'Más tarde',
    onbStarHint: 'Si te gusta NiwanOffice, danos una estrella en GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a NiwanOffice',
    ...
    onbBody2:
      'NiwanOffice aún está en alfa. Únete al chat grupal en GenTeam para compartir comentarios y ayudar a dar forma a lo que viene.',
  ...
  th: {
    ...
    loggedInGenspark: 'ลงชื่อเข้าใช้ แล้ว',
    ...
    starPromptTitle: 'ชอบ NiwanOffice ไหม?',
    starPromptTitleN: 'คุณเปิดเอกสารด้วย NiwanOffice ไปแล้ว {n} ไฟล์',
    starPromptBody:
      'NiwanOffice ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
    starPromptGo: 'กดดาวเลย',
    starPromptDone: 'กดแล้ว',
    starPromptLater: 'ไว้ทีหลัง',
    onbStarHint: 'ถ้าชอบ NiwanOffice ฝากกดดาวให้เราบน GitHub ด้วยนะ',
    setEmail: 'อีเมล',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ NiwanOffice',
    ...
    onbBody2:
      'NiwanOffice ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน GenTeam เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
  ...
  id: {
    ...
    starPromptTitle: 'Suka NiwanOffice?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan NiwanOffice',
    starPromptBody:
      'NiwanOffice gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Nanti saja',
    onbStarHint: 'Jika Anda menyukai NiwanOffice, beri kami bintang di GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di NiwanOffice',
    ...
    onbBody2:
      'NiwanOffice masih dalam tahap alpha. Gabung obrolan grup di GenTeam untuk berbagi masukan dan ikut menentukan arah ke depan.',
  ...
  ru: {
    ...
    starPromptTitle: 'Нравится NiwanOffice?',
    starPromptTitleN: 'Вы уже открыли {n} документов в NiwanOffice',
    starPromptBody:
      'NiwanOffice — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
    starPromptGo: 'Поставить звезду',
    starPromptDone: 'Уже поставлена',
    starPromptLater: 'Позже',
    onbStarHint: 'Если вам нравится NiwanOffice, поставьте нам звезду на GitHub.',
    setEmail: 'Эл. почта',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в NiwanOffice',
    ...
    onbBody2:
      'NiwanOffice пока в альфа-версии. Присоединяйтесь к групповому чату в GenTeam, чтобы делиться отзывами и влиять на дальнейшее развитие.',
  ...
  ar: {
    ...
    loggedInGenspark: 'تم تسجيل الدخول',
    ...
    setAiGensparkHint: 'يستخدم تسجيل الدخول؛ لا حاجة لمفتاح API.',
    setAiByokNote:
      'تستخدم المحادثات مفتاحك الخاص؛ أدوات السحابة (بحث الويب وتوليد الصور) ما زالت تتطلب تسجيل الدخول.',
    setAiSave: 'حفظ',
    setAiSaved: 'تم الحفظ',
    ...
    starPromptTitle: 'هل أعجبك NiwanOffice؟',
    starPromptTitleN: 'لقد فتحت {n} من المستندات في NiwanOffice',
    starPromptBody: 'NiwanOffice مجاني ومفتوح المصدر. نجمة على GitHub هي أفضل دعم للفريق.',
    starPromptGo: 'ضع نجمة',
    starPromptDone: 'وضعتها بالفعل',
    starPromptLater: 'لاحقًا',
    onbStarHint: 'إذا أعجبك NiwanOffice، ضع لنا نجمة على GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في NiwanOffice',
    ...
    onbBody2:
      'لا يزال NiwanOffice في مرحلة ألفا. انضم إلى الدردشة الجماعية على GenTeam لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
  ...
  pt: {
    ...
    starPromptTitle: 'Gostando do NiwanOffice?',
    starPromptTitleN: 'Você já abriu {n} documentos com o NiwanOffice',
    starPromptBody:
      'O NiwanOffice é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
    starPromptGo: 'Dar uma estrela',
    starPromptDone: 'Já dei',
    starPromptLater: 'Mais tarde',
    onbStarHint: 'Se você gosta do NiwanOffice, deixe uma estrela no GitHub.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao NiwanOffice',
    ...
    onbBody2:
      'O NiwanOffice ainda está em alfa. Entre no chat em grupo no GenTeam para compartilhar feedback e ajudar a moldar o que vem a seguir.',
  ...
  it: {
    ...
    starPromptTitle: 'Ti piace NiwanOffice?',
    starPromptTitleN: 'Hai aperto {n} documenti con NiwanOffice',
    starPromptBody:
      'NiwanOffice è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
    starPromptGo: 'Metti una stella',
    starPromptDone: 'Già fatto',
    starPromptLater: 'Più tardi',
    onbStarHint: 'Se ti piace NiwanOffice, lasciaci una stella su GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in NiwanOffice',
    ...
    onbBody2:
      'NiwanOffice è ancora in alpha. Unisciti alla chat di gruppo su GenTeam per condividere feedback e contribuire a plasmare il futuro.',
  ...
  pl: {
    ...
    starPromptTitle: 'Podoba Ci się NiwanOffice?',
    starPromptTitleN: 'Otwarto już {n} dokumentów w NiwanOffice',
    starPromptBody:
      'NiwanOffice jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
    starPromptGo: 'Daj gwiazdkę',
    starPromptDone: 'Już zrobione',
    starPromptLater: 'Później',
    onbStarHint: 'Jeśli podoba Ci się NiwanOffice, zostaw nam gwiazdkę na GitHubie.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nowa karta',
    // First-run onboarding
    onbTitle1: 'Witamy w NiwanOffice',
    ...
    onbBody2:
      'NiwanOffice jest wciąż w fazie alfa. Dołącz do czatu grupowego na GenTeam, aby dzielić się opiniami i współtworzyć jego przyszłość.',
  ...
  nl: {
    ...
    starPromptTitle: 'Bevalt NiwanOffice?',
    starPromptTitleN: 'Je hebt al {n} documenten geopend met NiwanOffice',
    starPromptBody:
      'NiwanOffice is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
    starPromptGo: 'Geef een ster',
    starPromptDone: 'Al gedaan',
    starPromptLater: 'Later',
    onbStarHint: 'Als NiwanOffice je bevalt, geef ons dan een ster op GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij NiwanOffice',
    ...
    onbBody2:
      'NiwanOffice is nog in alfa. Doe mee aan de groepschat op GenTeam om feedback te delen en mee te bepalen wat er komt.',
  ...
  ms: {
    ...
    loggedInGenspark: 'Telah log masuk',
    ...
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan NiwanOffice',
    starPromptBody:
      'NiwanOffice percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Kemudian',
    onbStarHint: 'Jika anda suka NiwanOffice, beri kami bintang di GitHub.',
    setEmail: 'E-mel',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke NiwanOffice',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'NiwanOffice masih dalam peringkat alfa. Sertai sembang kumpulan di GenTeam untuk berkongsi maklum balas dan membentuk masa depannya.',
  ...
  he: {
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    starPromptTitle: 'נהנים מ-NiwanOffice?',
    starPromptTitleN: 'פתחת {n} מסמכים עם NiwanOffice',
    starPromptBody: 'NiwanOffice חינמי ובקוד פתוח. כוכב ב-GitHub הוא התמיכה הטובה ביותר בצוות.',
    starPromptGo: 'לתת כוכב',
    starPromptDone: 'כבר נתתי',
    starPromptLater: 'אחר כך',
    onbStarHint: 'אם NiwanOffice מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
    setEmail: 'אימייל',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-NiwanOffice',
    ...
    onbBody2:
      'NiwanOffice עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-GenTeam כדי לשתף משוב ולעזור לעצב את ההמשך.',
  ...
  hi: {
    ...
    starPromptTitle: 'NiwanOffice पसंद आ रहा है?',
    starPromptTitleN: 'आपने NiwanOffice में {n} दस्तावेज़ खोले हैं',
    starPromptBody:
      'NiwanOffice मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
    starPromptGo: 'स्टार दें',
    starPromptDone: 'पहले ही दे दिया',
    starPromptLater: 'बाद में',
    onbStarHint: 'अगर आपको NiwanOffice पसंद है, तो हमें GitHub पर स्टार दें।',
    setEmail: 'ईमेल',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'NiwanOffice में आपका स्वागत है',
    ...
    onbBody2:
      'NiwanOffice अभी अल्फ़ा में है। GenTeam पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
  ...
  'zh-TW': {
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',
    cloudLoginHint: '登入 帳號，查看你在網頁端建立的專案。',
    cloudEmpty: '還沒有網頁端專案。',
    ...
    setAiGensparkHint: '使用 帳號登入，無需 API key。',
    setAiByokNote: '對話使用你自己的 key；網頁搜尋、生圖等雲端工具仍需登入。',
    setAiSave: '儲存',
    setAiSaved: '已儲存',
    setAiTest: '測試連線',
    setAiTesting: '測試中…',
    ...
    starPromptTitle: '喜歡 NiwanOffice 嗎？',
    starPromptTitleN: '你已經用 NiwanOffice 開啟了 {n} 個文件',
    starPromptBody: 'NiwanOffice 是免費的開源軟體。到 GitHub 給我們一顆星，是對團隊最好的支持。',
    starPromptGo: '去給星星',
    starPromptDone: '已經給過了',
    starPromptLater: '以後再說',
    onbStarHint: '如果你喜歡 NiwanOffice，歡迎到 GitHub 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
